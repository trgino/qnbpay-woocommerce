...
paySmart3D API, QNBpay ödeme entegrasyon sistemine sipariş ve kredi kartı ayrıntı bilgilerini göndermek için kullanılır. Üye işyeri web sitesi ödeme formunu gönderdikten sonra kullanıcı banka sayfasına yönlendirilecektir. Ödeme, banka ağ geçidinde bir SMS koduyla doğrulanacaktır. Ödeme başarılı olduktan sonra, kullanıcı üye iş yerinin başarı URL'sine yönlendirilecektir, aksi takdirde üye iş yeri tarafından belirlenen iptal URL'ne yönlendirilecektir. Bu ödeme API'sinde diğer ödeme API gibi getpos API 'yi çağırmaya gerek yoktur.

**Özel Notlar**

1. paySmart3D API 'na ajax isteğini göndermeyin. "/api/paySmart3D" URL 'ine html form gönderimi olmalıdır.
2. Örnek dosya olarak verilen örnek kodu kullanın. [Örnek Dosya](https://apidocs.qnbpay.com.tr/files/API_Smart3D_Form.html)
...
`qnbpay_status`, `order_id` ve `invoice_id`. Örneğin, başarılı URL https://alanadim.com/ ise, başarılı ödemeden sonra QNBPAY, https://alanım.com/?qnbpay\_status=1&order\_no=234234232&invoice\_id=73434 adresine yönlendirecektir.
...
| Test | https://test.qnbpay.com.tr/ccpayment/api/paySmart3D |
| --- | --- |
| Canlı | https://portal.qnbpay.com.tr/ccpayment/api/paySmart3D |
...
[
  {
    "cc_holder_name":"Card Holder Name",
    ...
    "invoice_id":"sample-123",
    "invoice_description":" INVOICE TEST DESCRIPTION",
    "total":20,
    "merchant_key":"$2y$10$N9IJkgazXMUwCzpn7NJrZePy3v.dIFOQUyW4yGfT3eWry6m.KxanK",
    "items": "[{"name":"Item3","price":20,"qnantity":1,"description":"item3 description"}]",
    "name" : "Aydın",
    "surname" : "Ozturk",
    "hash_key" :"6061f88cc5ea2cda:3dc1:H6xFF6uc53__yWuNOW8yFQj__20inWnTpYhcxla8t0TAzOyHb3wIRREG6X8Wvrguo4U6tLn2YWNP__yiSU6hR71jGINoMyBg2XlN1W8DoOGRiMAWqQmKCL__jG3mhyZoxsp__",
